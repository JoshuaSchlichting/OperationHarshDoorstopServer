...
"$UE4_PROJECT_ROOT/HarshDoorstop/Binaries/Linux/HarshDoorstopServer-Linux-Shipping" HarshDoorstop LamDong?bBotAutofill?BluforNumBots=4?OpforNumBots=16?BluforNumTickets=600?OpforNumTickets=600?MaxPlayers=32 -SteamServerName=\"$1\" -RCONPassword="$2"
